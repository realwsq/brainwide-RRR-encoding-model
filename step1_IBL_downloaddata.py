...
cache_folder = make_folder("./IBL_cache") 
...
data_folder = make_folder("./data/downloaded") # folder to save the downloaded data
...
for area_acronym in areas_all:
    ...
    for pidi, pid_ in enumerate(pids_area):
        ...
        fname = os.path.join(data_folder, f"data_{eid}.npz")
        ...
        data_ret = load_data_from_pid(eid, one, ba,
                                      ...
                                      lambda _: filter_neurons_func(_,
                                                                    ...
                                                                    only_area=(False)),
                                      spsdt=10e-3, min_neurons=10, Twindow=1.2, t_bf_stimOn=0.3,
...
print("finished downloading data for all areas!")